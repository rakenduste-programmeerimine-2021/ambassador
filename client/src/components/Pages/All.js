...
const All = (props) => {
	...
	const loadChats = () => {
		if (document.getElementById("username").value) {
			...
			axios
				.get("/api/chats/searching/" + document.getElementById("username").value)
				.then((response) => {
	...
	return (
		<div className="container">
			<div className="row">
				...
				<div className="col hide-on-mobile">{selectedChat === null ? null : <MainMessageChat chat={selectedChat} unselectChat={unselectChat} />}</div>
			</div>
		</div>
	);
};
