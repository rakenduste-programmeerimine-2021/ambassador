			...
			<div className="row">
				<div className="padding-32 side-col full-height white-bg mobile-full-height">
					<div className="margin-s padding-32 no-padding-mobile">
						<h1 className="margin-m text-center font-size-l">Ambassador</h1>
					</div>

					<div className="margin-ml">
						<Link to="/register">
							<Button btnStyle="Button margin-xs">Register</Button>
						</Link>
						<Link to="/login">
							<Button btnStyle="Button margin-xs">Login</Button>
						</Link>
					</div>
				</div>
