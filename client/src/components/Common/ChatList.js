		...
		return (
			<div className="user-list col">
				{props.chats.map((chat, index) => {
					...
					return <ChatListItem key={index} id={chat._id} userId={userId} name={name} lastUpdate={chat.lastUpdate} created={chat.created} retrieveChatId={props.retrieveChatId} />;
				})}
			</div>
		);
	}
